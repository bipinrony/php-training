...
$cartListSql = "SELECT users.name as customer_name,products.name, products.image, products.discounted_price as price, carts.* FROM carts 
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Carts</h1>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo BASE_URL . $cart['image']; ?>" alt=""
                                                            height="50" width="50"></td>
                                                    <td><?php echo $cart['customer_name'] . "(" . $cart['user_id'] . ")"; ?>
                                                    </td>
